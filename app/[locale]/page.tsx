...
export default async function HomePage({
  ...
  const upcomingConcerts = allConcerts.filter((concert) =>
    concert.performances.some((p) => new Date(p.date) >= new Date())
  );
      ...
      <section className="relative -mx-6 -mt-20 mb-0 h-[60vh] min-h-[400px] max-h-[600px] flex items-end justify-center">
        ...
        >
          <div
            ...
            style={{
              backgroundImage:
                'linear-gradient(to top, rgb(231 229 228) 0%, transparent 30%)',
            }}
          />
        </div>
              ...
              upcomingConcerts.map((concert) => (
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-neutral-700 mb-3">{concert.composers}</p>
                  </Link>
